...
public class PredictedSeedListAdapter implements ListAdapter {
    Context context;
    TeamClickListener teamClickListener = new TeamClickListener();

    public PredictedSeedListAdapter(Context context) {
    ...
    @Override
    public int getCount() {
        return MainActivity.teamList.size();
    }

    @Override
    public Object getItem(int position) {
        return MainActivity.predictedSeedList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            rowView = layoutInflater.inflate(R.layout.team_row, parent, false);
        }
