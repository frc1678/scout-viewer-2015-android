...
public class ThirdLandfillPickListAdapter implements ListAdapter {
    Context context;
    TeamClickListener teamClickListener = new TeamClickListener();

    public ThirdLandfillPickListAdapter(Context context) {
    ...
    @Override
    public int getCount() {
        return MainActivity.thirdPickListLandfill.size();
    }

    @Override
    public Object getItem(int position) {
        return MainActivity.thirdPickListLandfill.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        seedLabel.setText(Math.round(((Team) getItem(position)).getCalculatedData().getThirdPickAbilityLandfill()) + "");
