...
public class SecondPickListAdapter implements ListAdapter {
    Context context;
    ...
    @Override
    public int getCount() {
        return MainActivity.secondPickList.size();
    }

    @Override
    public Object getItem(int position) {
        return MainActivity.secondPickList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        seedLabel.setText(Math.round(((Team) getItem(position)).getCalculatedData().getSecondPickAbility()) + "");
