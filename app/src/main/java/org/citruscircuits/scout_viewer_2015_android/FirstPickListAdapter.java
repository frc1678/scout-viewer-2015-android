...
public class FirstPickListAdapter implements ListAdapter {
    Context context;
    ...
    @Override
    public int getCount() {
        return MainActivity.firstPickList.size();
    }

    @Override
    public Object getItem(int position) {
        return MainActivity.firstPickList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            rowView = layoutInflater.inflate(R.layout.picklist_row, parent, false);
        }
        ...
        seedLabel.setText(Math.round((((Team) getItem(position)).getCalculatedData().getFirstPickAbility())) + "");
