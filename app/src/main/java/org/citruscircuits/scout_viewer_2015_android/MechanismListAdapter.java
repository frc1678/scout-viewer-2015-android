...
public class MechanismListAdapter implements ListAdapter {
    Context context;
    TeamClickListener teamClickListener = new TeamClickListener();

    public MechanismListAdapter(Context context) {
    ...
    @Override
    public int getCount() {
        return MainActivity.mechanismList.size();
    }

    @Override
    public Object getItem(int position) {
        return MainActivity.mechanismList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        seedLabel.setText((((Team) getItem(position)).getUploadedData().getProgrammingLanguage() + ""));
